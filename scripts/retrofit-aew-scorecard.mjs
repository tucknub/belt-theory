...
@media(max-width:560px){.archive-aew-scorecard-hero{min-height:auto}.archive-aew-scorecard-photo{min-height:480px}.archive-aew-scorecard-evidence>img{min-height:280px}}
`;
