...
if (manifest.assets.length !== 7) failures.push(`Expected 7 WWE/AEW champion assets, found ${manifest.assets.length}.`);
...
const checks = {
  ...
  'report-wwe-vs-aew.html': ['ff-matchup-star-pair','cody-rhodes-undisputed-champion-portrait-2024','hangman-page-aew-world-champion-2021'],
  'image-credits.html': ['ff-star-credit-section-wwe-aew','Cody Rhodes with the Undisputed WWE Championship','Cody Rhodes pointing to fans while carrying the Undisputed WWE Championship','Roman Reigns with the WWE Universal Championship','Damian Priest as World Heavyweight Champion','Hangman Adam Page photographed as AEW World Champion','Swerve Strickland as AEW World Champion','Interim AEW World Champion Jon Moxley and lineal AEW World Champion CM Punk']
};
...
if (!comparison.includes('cody-rhodes-undisputed-champion-portrait-2024')) failures.push('WWE vs AEW: comparison-safe Cody portrait missing.');
...
console.log('WWE/AEW champion imagery verified: seven rights-approved photographs are self-hosted, sharp champion imagery leads both promotions, and the comparison keeps separate authentic source frames.');
